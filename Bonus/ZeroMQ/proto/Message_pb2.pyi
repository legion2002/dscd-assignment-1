...
class GetArticlesForServer(_message.Message):
...
class StandardFormat(_message.Message):
    __slots__ = ["articlesServer", "getArticles", "join", "leave", "publish", "typeOfRequest"]
    ARTICLESSERVER_FIELD_NUMBER: _ClassVar[int]
    ...
    TYPEOFREQUEST_FIELD_NUMBER: _ClassVar[int]
    articlesServer: GetArticlesForServer
    getArticles: GetArticlesRequest
    join: JoinServerRequest
    leave: LeaveServerRequest
    publish: PublishArticlesRequest
    typeOfRequest: str
    def __init__(self, typeOfRequest: _Optional[str] = ..., join: _Optional[_Union[JoinServerRequest, _Mapping]] = ..., leave: _Optional[_Union[LeaveServerRequest, _Mapping]] = ..., getArticles: _Optional[_Union[GetArticlesRequest, _Mapping]] = ..., publish: _Optional[_Union[PublishArticlesRequest, _Mapping]] = ..., articlesServer: _Optional[_Union[GetArticlesForServer, _Mapping]] = ...) -> None: ...
